...
template Utxo(levels, nIns, nOuts, zeroLeaf) {
    ...
    component publicInAmtN2B;
    component publicOutAmtN2B;

    publicInAmtN2B = Num2Bits(252);
    publicInAmtN2B.in <== publicInAmt;
    publicOutAmtN2B = Num2Bits(252);
    publicOutAmtN2B.in <== publicOutAmt;
    ...
    // signal slt <== LessThan(252)([publicInAmt,0]);
    // slt === 0;
